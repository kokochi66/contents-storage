...
class Song:
    def __init__(self, title_kr, title_origin, vocal_key, highlight_start, highlight_end, category_name, category_key, release_date, file_path):
        ...
        self.key = title_origin                             # 검색어용 key String

    def save_to_file(self):
        DataService.save_data('song_data.json', self.__dict__)
