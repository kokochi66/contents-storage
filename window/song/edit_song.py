...
class EditSongWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.song_form.addRow("장르선택", self.genre_input)
        ...
        self.song_form.addRow("방영기간", self.airing_period_list)

        self.director_input = QLineEdit()
        self.song_form.addRow("감독", self.director_input)
               
        self.production_company_input = QLineEdit()
        self.song_form.addRow("제작사", self.production_company_input)

        self.word_input = QLineEdit()
        self.song_form.addRow("검색어 키", self.word_input)
